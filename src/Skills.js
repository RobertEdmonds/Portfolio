...
export default function Skills(){
    return(
        <>
            <h1 className='Info-title'>Tech Skills</h1>
            <ul className="skill-list">
                <li className="skill-item">Linux</li>
                <li className="skill-item">iOS</li>
                <li className="skill-item">SQL</li>
                <li className="skill-item">SQLite</li>
                <li className="skill-item">Postgres</li>
                <li className="skill-item">Bootstrap</li>
                <li className="skill-item">MaterialUI</li>
                <li className="skill-item">CSS</li>
                <li className="skill-item">Ruby</li>
                ...
                <li className="skill-item">Moment</li>
